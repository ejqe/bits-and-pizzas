package com.erickeugenio.bitsandpizzas
...
import com.erickeugenio.bitsandpizzas.databinding.FragmentOrderBinding
    ...
    override fun onCreateView(
        ...
        binding.fab.setOnClickListener {
            ...
            if (pizzaType == -1) {
                ...
                text += (if (binding.parmesan.isChecked) ",extra parmesan" else "").toString()
